...
@ViewModelInject
    ...
    public void getPokemons(){
        repository.getPokemons()
                ...
                .map(new Function<PokemonResponse, ArrayList<Pokemon>>() {
                    ...
                    public ArrayList<Pokemon> apply(PokemonResponse pokemonResponse) throws Throwable {
                        ...
                        for (Pokemon pokemon : list){
                            ...
                            pokemon.setUrl("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/"
                ...
                .subscribe(result->pokemonList.setValue(result),error-> Log.e(TAG, "viewModel: "+error.getMessage() ));
    }
    ...
    public void getFavPokemons(){
        favList = repository.getPokemnList();
    }
}
